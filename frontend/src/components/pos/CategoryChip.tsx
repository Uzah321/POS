...
export default function CategoryChip({
  ...
  return (
    <button
      ...
      className={`flex-shrink-0 flex flex-col items-center justify-center gap-1 min-w-[92px] min-h-[76px] px-3 py-2 rounded-2xl border-2 font-bold text-xs text-center leading-tight transition-all touch-manipulation
